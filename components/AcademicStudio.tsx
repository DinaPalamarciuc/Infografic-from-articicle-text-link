...
import { generateAcademicInfographic } from '../services/geminiService';
    ...
    try {
      ...
      if (result) {
        ...
        setMetadata(prev => ({
            ...
            description: `Academic infographic generated by AI in ${selectedLanguage} for concept: ${topic}`,
            keywords: `educational, ${selectedSubject}, infographic, ${selectedLanguage}`,
